...
function newTicket(){
    ...
    option1.value = 'lecturer';
    option3.value = 'support staff';
    option4.value = 'Admin';
    option2.value = 'external member';
    option.innerHTML = 'student';
    option1.innerHTML = 'lecturer';
    option3.innerHTML = 'support staff';
    option4.innerHTML = 'Admin';
    option2.innerHTML = 'external member';
